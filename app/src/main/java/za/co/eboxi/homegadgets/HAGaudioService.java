...
public class HAGaudioService extends Service implements OnCompletionListener {
    public static final String INTENT_BASE_NAME = "AudioPlayerS";
...
//    private List<Track> tracks = new ArrayList<Track>(); // this collection should be encapsulated in another class.
    private List<String> tracks = new ArrayList<String>(); // this collection should be encapsulated in another class.
 //   private MusicRepository musicRepository = new MusicRepository();
    ...
    public class AudioPlayerBinder extends Binder {
        public HAGaudioService getService() {
            Log.v(TAG, "AudioPlayerBinder: getService() called");
            return HAGaudioService.this;
        }
    }
    ...
    public void onLowMemory() {
        ...
        String message = "Closing low on memory";
...
//    }
    ...
    private class AudioPlayerBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d(TAG, "Received intent for action " + intent.getAction() + " to play " + name);
//            if( PLAY_ALBUM.equals(action)) {
//                playAlbum(name);
//            } else if( QUEUE_ALBUM.equals(action)) {
//                queueAlbum(id);
